  ...
  const handleLayerAction = (action, elementId) => {
    setElements(currentElements => {
      ...
      if (action === 'bring-forward' && currentIndex < newElements.length - 1) {
        [newElements[currentIndex].zIndex, newElements[currentIndex + 1].zIndex] = 
        [newElements[currentIndex + 1].zIndex, newElements[currentIndex].zIndex];
    ...
    return elements.map(elementInfo => {
      ...
      return (
        <div 
          ...
          style={specificStyle}
          onClick={(e) => { e.stopPropagation(); setSelectedElementId(id); }}
        >
